...
import CustomerEstimate from '../../components/sections/customerEstimate'
...
<nav className="bg-white p-2 md:mx-2 md:my-2 md:rounded-xl md:border md:border-gray-200 hover:border-gray-300">
        ...
        <div className="flex justify-between">
            <div className="flex space-x-7">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    <a href="https://inventory.borete.com/parts" className="hover:text-black font-medium text-gray-500">Parts</a>
            ...
            <div className="hidden md:flex items-center space-x-3">
                ...
                <a href="https://inventory.boretec.com/parts" className="bg-gray-800 hover:bg-black text-white rounded-md py-2 px-2">Create Another Estimate</a>
            </div>
    ...
    <div className={`mobile-menu ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <ul className="">
            ...
            <li><a href="https://inventory.boretec.com/parts" className="hover:text-black font-medium text-gray-500">Parts</a></li>
            ...
            <li><a href="https://inventory.boretec.com/parts" className="hover:bg-black font-medium bg-gray-800 rounded-md py-1 px-2 text-white">Create Another Estimate</a></li>
        </ul>
    </div>
</nav>
