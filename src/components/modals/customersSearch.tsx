  ...
  return (
    <section className="text-gray-600">
      ...
      <div className="flex justify-end">
        <button className="mx-1 whitespace-nowrap" onClick={()=>setShowAddCustomer(true)}>+ customer</button>
      </div>
      </div>
      {showAddCustomer && <AddCustomer onClose={handleClose} sendCustomerToParent={setCustomerFromAdd}/>}
